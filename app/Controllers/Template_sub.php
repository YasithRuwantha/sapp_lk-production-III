...
class Template_sub extends BaseController
{
    private $data;
	...
	{
        auth_rd();
        $this->data['active_module'] = "/template_sub/list_all/";
        $this->data['csrf'] = 1;
        ...
        return view('template_sub/list_all',$this->data);
    }

    public function add_edit($entity_id=0,$id=0)
	{
        auth_rd();
        $this->data['active_module'] = "/template_sub/add_edit/";
        $this->data['csrf'] = 1;
        $this->data['entity_id'] = $entity_id;
        ...
        return view('template_sub/add_edit',$this->data);
    }
    ...
    private function process_form_add_edit($entity_id=0,$id=0)
    {
        ...
        if(isset($_POST['csrf']))
        {
            ...
            { 
                ...
                header("Location:" . base_url("/template_sub/list_all/" . $entity_id . "/" . $id . "/")); 
                die;
    ...
    public function delete($entity_id=0,$id=0)
    {
        ...
        header("Location:" . base_url("/template_sub/list_all/" . $entity_id)); 
        die;
    }
