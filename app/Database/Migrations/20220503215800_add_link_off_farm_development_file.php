...
class AddLinkOffFarmDevelopmentFile extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'off_farm_development_id'          => [
                ...
                'constraint'     => 11,
                'unsigned'       => true,
                'comment' => 'Refer off_farm_development table primary key',
            ],
            'file_id'          => [
                'type'           => 'BIGINT',
                'constraint'     => 20,
        ...
        $this->forge->createTable('link_off_farm_development_file');
    }

    public function down()
    {
        $this->forge->dropTable('link_off_farm_development_file');
    }
}