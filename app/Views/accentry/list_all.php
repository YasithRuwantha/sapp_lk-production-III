                ...
                <div class="animated fadeIn">
                    ...
                    <div class="clearfix">
                        <div class="float-left">
                            <h3 class="text-theme">Entry List</h3>
                            <p>List of double entries are listed here. By selecting each we can see the details.</p>
                        </div>
                        <!-- float-left -->
                        <div class="float-right">
                            <a href="<?php echo base_url("/accentry/add_edit/0"); ?>" class="btn btn-theme btn-round">
                                    ...
                                    <table id="exampleTableSearch" class="display table table-hover table-striped" cellspacing="0" width="100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo date("Y-m-d",$val['planned_date']); ?></td>
                                                <td title="Dr. <?php echo $val['dr_ledger']; ?> / Cr. <?php echo $val['cr_ledger']; ?>">
                                                    <?php echo substr($val['notes'],0,150); ?> <br>
                                                    Dr. <?php echo $val['dr_ledger']; ?> <br>Cr. <?php echo $val['cr_ledger']; ?>
                                                </td>
                                                <td><?php echo $val['type']; ?></td>
                                                <td>
                                                    <?php if($val['paid_date'] < 10){ ?>
                                                        <span class="badge badge-pill badge-secondary">Pending</span>
                                                    <?php }else{ ?>
                                                        <span class="badge badge-pill badge-primary">Complete</span>
                                                    <?php } ?>
                                                </td>
                                                <td><?php echo $val['dr_total']; ?></td>
                                                <td><?php echo $val['cr_total']; ?></td>
                                                <td>
                                                    <a href="<?php echo base_url("/accentry/add_edit/" . $val['id']); ?>" class="badge badge-pill badge-primary"><i class="mdi mdi-pencil"></i> EDIT</a>
                                                    <span data-url="<?php echo base_url("/accentry/delete/" . $val['id']); ?>" class="pointer alert-confirm badge badge-pill badge-danger"><i class="mdi mdi-close"></i> DELETE</span>
                                                </td>
                                            </tr>
                                        <?php 
                                            }
