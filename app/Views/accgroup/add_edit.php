<?php
$form_url = base_url("/accgroup/add_edit/" . $id);
$lock_url = base_url("/accgroup/add_edit/" . $id . "/1");
?><!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="col-md-12">
                        <div class="clearfix">
                            <div class="float-left">
                                <h3 class="text-theme">Group</h3>
                                <p>An account group is a collection of ledgers in which account transactions are recorded.</p>
                            </div>
                            <!-- float-left -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <?php $field_name = "name"; ?>
                                            <label for="validationCustom<?php echo $tag_index; ?>">Group label</label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <?php $field_name = "code"; ?>
                                            <label for="validationCustom<?php echo $tag_index; ?>">Group code</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <?php $field_name = "affects_gross"; ?>
                                            <label for="validationCustom<?php echo $tag_index; ?>">Affects</label>
                                            <select name="<?php echo $field_name; ?>" class="form-control select2<?php if($validation->hasError($field_name)){ ?> is-invalid<?php } ?>" data-plugin="select2" id="validationCustom<?php echo $tag_index+1; ?>">
                                                <?php
                                                foreach($affects as $dkey=>$dval)
                                                {
                                                ?>
