                ...
                <div class="animated fadeIn">
                    ...
                    <div class="clearfix">
                        <div class="float-left">
                            ...
                            <p>This is the balance sheet for selected ledger.</p>
                        </div>
                    </div>
                    <!-- end clearfix -->
                    ...
                    <div class="row"> 
                        <div class="col-md-12">
                            <div class="card card-accent-theme">
                                <div class="card-body">
                                    <h4 class="text-theme">Ledger | <?php echo $ledger['name']; ?></h4>
                                    <table id="exampleTableSearch" class="display table table-hover table-striped" cellspacing="0" width="100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="fc-rtl"><?php if(isset($val['debit'])){ echo $val['debit']; } ?></td>
                                                <td class="fc-rtl"><?php if(isset($val['credit'])){ echo $val['credit']; } ?></td>
                                                <td class="fc-rtl"><?php echo $val['net_balance']; ?></td>
                                            </tr>
                                        <?php 
                                            }
                                        }
