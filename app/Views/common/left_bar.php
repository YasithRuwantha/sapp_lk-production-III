...
if (function_exists('get_config')) {
    $config_data = get_config(76);
    if ($config_data && is_string($config_data)) {
        $abbreviations = json_decode($config_data, TRUE);
			...
			<div class="sidebar" id="sidebar">
				<div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu dark">
						<ul>
						<?php if(isset($_SESSION['user']['fname']) || true){ ?>
							<li class="menu-title"><span>SUMMARY</span></li>
							<?php if(is_auth(1) || true){ ?>
							<li class="submenu">
							...
							<?php if(is_auth(43) || is_auth(7) || is_auth(55) || true){ ?>
							<li class="submenu">
							...
							<?php if(is_auth(55) || is_auth(57) || is_auth(63) || is_auth(61) || is_auth(67) || is_auth(69) || true){ ?>
							<li class="submenu">
							...
							<?php } ?>
							<?php if(is_auth(79) || is_auth(75) || is_auth(73) || is_auth(27) || is_auth(25) || true){ ?>
							<li class="submenu">
							...
							<?php if(is_auth(99) || is_auth(97) || is_auth(105) || is_auth(103) || true){ ?>
							<li class="submenu">
							...
							<?php } ?>
							<?php if(is_auth(15) || is_auth(13) || is_auth(121) || is_auth(123) || true){ ?>
							<li class="submenu">
							...
							<?php } ?>
							<?php if(is_auth(127) || is_auth(128) || is_auth(129) || is_auth(135) || is_auth(134) || is_auth(133) || true){ ?>
							<li class="submenu">
							...
							<?php } ?>
							<?php if(is_auth(127) || is_auth(129) || is_auth(135) || is_auth(133) || true){ ?>
							<li class="submenu">
							...
							<?php if(is_auth(31) || is_auth(33) || true){ ?>
							<li class="submenu">
