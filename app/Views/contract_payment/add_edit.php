						...
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/contract_payment/list_all/" . $entity_id); ?>">Contract Payment</a></li>
							...
							<div class="card">
								...
								<div class="card-body">
                                    <?php
                                        $inc=1;
                                    ?>
									<form method="post" action="<?php echo base_url("/contract_payment/add_edit/" . $entity_id . "/" . $id); ?>" enctype="multipart/form-data">
                                        <input name="csrf" value="<?php echo $csrf; ?>" type="hidden">

                                        <div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Transection date</label>
											<div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-sm-10">
                                                ...
                                                ?>
                                                    <a href="<?php if(isset($val['relative_path'])){ echo $s3path; } ?>" target="_blank"><?php if(isset($val['file_name'])){ echo $val['file_name']; } ?></a><br>
                                                <?php }} ?>
                                            </div>
										</div>
