		...
		<div class="main-wrapper">
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Contract Supplier List</li>
								</ul>
							</div>
							<div class="col-auto">
								<?php if(is_auth("63")){ ?>
								<a href="<?php echo base_url("/contract_supplier/add_edit/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/contract_supplier/list_all/"); ?>" enctype="multipart/form-data">
										...
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    ...
                                                    <td class="text-right">
														<?php if(is_auth("64")){ ?>
														<a href="<?php echo base_url("/contract_supplier/add_edit/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 													
														<?php }?>
														<?php if(is_auth("65")){ ?>
                                                        <a href="<?php echo base_url("/contract_supplier/delete/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
														<?php }?>
													</td>
												</tr>
                                            <?php
