...
<html lang="en">
	...
	<body>
				...
				<div class="content container-fluid">
								...
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<div class="dash-title">Active Farmers</div>
							...
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<div class="dash-title">Loan Farmers</div>
											<div class="dash-counts">
                                                <?php 
							...
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<div class="dash-title">Grant Farmers</div>
											<div class="dash-counts">
                                                <?php 
                    ...
                    <div class="row">
                        <div class="col-md-6">	
							<div class="card">
									...
									<div class="card-body">
										<div id="pie_gender_composition"></div>
									</div>
								</div>
						</div>
                        <div class="col-md-6">	
							<div class="card">
									<div class="card-header">
										<div class="card-title">Recomendation status</div>
									</div>
									<div class="card-body">
										<div id="pie_recomendation_status"></div>
									</div>
								</div>
						</div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">	
							<div class="card">
									<div class="card-header">
										<div class="card-title">Main income source of farmers</div>
									</div>
									<div class="card-body">
										<div id="bar_income_source"></div>
									</div>
								</div>
						</div>
                    </div>
        ...
        $( function() {
            ...
            var columnCtx = document.getElementById("bar_district"),
            columnConfig = {
            ...
            // Column chart income source
            var columnCtx = document.getElementById("bar_income_source"),
            columnConfig = {
                colors: ['#7638ff', '#fda600'],
                series: [
                    {
            ...
            //Pie Chart
            var pieCtx = document.getElementById("pie_gender_composition"),
            pieConfig = {
            ...
            //Pie Chart
            var pieCtx = document.getElementById("pie_recomendation_status"),
            pieConfig = {
                colors: ['#7638ff', '#ff737b', '#fda600', '#1ec1b0'],
                series: [55, 40, 20, 10],
                chart: {
