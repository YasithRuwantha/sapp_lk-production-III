...
<html lang="en">
	...
	<body>
								...
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<div class="dash-title">Number of Traninig Conducted</div>
							...
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<div class="dash-title">Number of Traninig Cancelled</div>
											<div class="dash-counts">
                                                <?php 
							...
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<div class="dash-title">Total Participants</div>
											<div class="dash-counts">
                                                <?php 
                                                    $direction = get_query_template_attom(6); 
                                                    if(strlen($direction)==0){ $direction=0; }
                        ...
                        <div class="col-md-6">	
							<div class="card">
									<div class="card-header">
										<div class="card-title">Type of training</div>
									</div>
									<div class="card-body">
										<div id="pie_training_type"></div>
									</div>
								</div>
						</div>
                        <div class="col-md-6">	
        ...
        $( function() {
            ...
            var columnCtx = document.getElementById("bar_projects"),
            columnConfig = {
            ...
            //Pie Chart
            var pieCtx = document.getElementById("pie_training_type"),
            pieConfig = {
            ...
            //Pie Chart
            var pieCtx = document.getElementById("pie_organized_by"),
            pieConfig = {
                colors: ['#7638ff', '#ff737b', '#fda600', '#1ec1b0'],
                series: [55, 40, 20, 10],
                chart: {
