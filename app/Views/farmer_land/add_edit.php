					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url("/user/farmer_project?user_type=2"); ?>">Farmers</a></li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/farmer_land/list_all/" . $entity_id); ?>">Progress Farmer Contribution</a></li>
							...
							<div class="card">
								...
								<div class="card-body">
                                    <?php
                                        $inc=1;
                                    ?>
									<form method="post" action="<?php echo base_url("/farmer_land/add_edit/" . $entity_id . "/" . $id); ?>" enctype="multipart/form-data">
