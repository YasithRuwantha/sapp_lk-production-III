...
<html lang="en">
	...
	<body>
				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Farmer Land</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url("/dashboard/default/"); ?>">Dashboard</a>
									</li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/farmer_land/list_all/"); ?>">Farmer Land</a>
									</li>
									<li class="breadcrumb-item active">Farmer Land</li>
								</ul>
							</div>
							<div class="col-auto">
							<?php if(is_auth("171")){ ?>
								<a href="<?php echo base_url("/farmer_land/add_edit/" . $entity_id); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/farmer_land/list_all/" . $entity_id); ?>" enctype="multipart/form-data">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    <td><?php echo $land_ownership[$val['land_ownership']]; ?></td>
                                                    <td><?php echo $val['land_extent']; ?></td>
                                                    <td class="text-right">
													<?php if(is_auth("172")){ ?>
														<a href="<?php echo base_url("/farmer_land/add_edit/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 														
													<?php }?>		
													<?php if(is_auth("173")){ ?>
														<a href="<?php echo base_url("/farmer_land/delete/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
													<?php }?>
													</td>
												</tr>
                                            <?php
		...
		$( function() {
			...
			setTimeout($( ".<?php echo $field_name; ?>" ).val( "<?php if(isset($_GET[$field_name])){ echo $_GET[$field_name]; } ?>" ), 200);
		});
		</script>
