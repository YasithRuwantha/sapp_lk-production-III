				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Startup Fund Disbursement List</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a>
									</li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/fpo_disbursement/list_all/"); ?>">Startup Fund Disbursement</a>
									</li>
									<li class="breadcrumb-item active">Startup Fund Disbursement List</li>
								</ul>
							</div>
							<div class="col-auto">
								<a href="<?php echo base_url("/fpo_disbursement/add_edit/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/fpo_disbursement/list_all/"); ?>" enctype="multipart/form-data">
										...
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    ...
                                                    <td><?php echo $val['proposal_amount']; ?></td>
                                                    <td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item" href="<?php echo base_url("/fpo_disbursement/add_edit/" . $val['id']); ?>">
																<i class="far fa-edit me-1"></i>Edit
																</a>
																<a class="dropdown-item" href="<?php echo base_url("/fpo_disbursement/delete/" . $val['id']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
