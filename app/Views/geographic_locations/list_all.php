				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">GEO Locations</h3>
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">GEO Locations</li>
								</ul>
							</div>
							<div class="col-auto">
							<?php if(is_auth("15") || is_auth(153) || is_auth(123)){ ?>
								<a href="<?php echo base_url("/geographic_locations/add_edit/" . $table . "/" . $entity_id . "/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/geographic_locations/list_all/" . $table . "/" . $entity_id . "/"); ?>" enctype="multipart/form-data">
										...
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    ...
                                                    <td><?php echo number_format($val['lat'],4); ?></td>
                                                    <td><?php echo number_format($val['lng'],4); ?></td>
                                                    <td class="text-right">
													<?php if(is_auth("16") || is_auth(154) || is_auth(124)){ ?>
														<a href="<?php echo base_url("/geographic_locations/add_edit/" . $table . "/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 														
													<?php } ?>
													<?php if(is_auth("17") || is_auth(155) || is_auth(125)){ ?>
														<a href="<?php echo base_url("/geographic_locations/delete/" . $table . "/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
													<?php } ?>
													</td>
												</tr>
                                            <?php
