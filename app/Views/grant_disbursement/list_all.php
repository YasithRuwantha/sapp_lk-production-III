				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto">
								<a href="<?php echo base_url("/grant_disbursement/add_edit/" . $entity_id); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/grant_disbursement/list_all/" . $entity_id); ?>" enctype="multipart/form-data">
										...
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    ...
                                                    <td class="text-right">
														<a href="<?php echo base_url("/grant_disbursement/add_edit/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 														
                                                        <a href="<?php echo base_url("/grant_item/list_all/" . $val['id'] . "/"); ?>/" class="btn btn-sm btn-white text-purple me-2"><i class="far fa-file me-1"></i> Grant Item Farmer</a>
														<a href="<?php echo base_url("/grant_disbursement/delete/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
													</td>
												</tr>
                                            <?php
                                                }
