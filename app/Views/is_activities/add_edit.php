						...
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/is_activities/list_all/" . $entity_id); ?>">IS Activities</a></li>
									<li class="breadcrumb-item active">IS Activities Details</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">IS Activities Details</h5>
								</div>
								<div class="card-body">
                                    <?php
                                        $inc=1;
                                    ?>
									<form method="post" action="<?php echo base_url("/is_activities/add_edit/" . $entity_id . "/" . $id); ?>" enctype="multipart/form-data">
