				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">IS Activities</h3>
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">IS Activities</li>
								</ul>
							</div>
							<div class="col-auto">
							<?php if(is_auth("129")){ ?>
								<a href="<?php echo base_url("/is_activities/add_edit/" . $entity_id); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/is_activities/list_all/" . $entity_id); ?>" enctype="multipart/form-data">
										...
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    ...
                                                    <td class="text-right">
													<?php if(is_auth("130")){ ?>
														<a href="<?php echo base_url("/is_activities/add_edit/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 														
													<?php } ?>
													<?php if(is_auth("131")){ ?>
														<a href="<?php echo base_url("/is_activities/delete/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
													<?php } ?>
													</td>
												</tr>
                                            <?php
