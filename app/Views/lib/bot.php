...
<img src="<?php echo base_url("/theme/bot/bot-icon.png"); ?>" width="60" class="chat-logo" />
<div class="chat">
  ...
  <div class="message-box">
    <textarea type="text" id="bot-input" class="message-input" placeholder="Type message..."></textarea>
  </div>
</div>
    ...
    function pushChat() {
        ...
        if(inputText && inputText.value && inputText.value.trim().length > 0) {
            ...
            lexruntime.postText(params, function(err, data) {
                console.log(data);
                $("#mCSB_1_container").append('<div class="message new"><figure class="avatar"><img src="<?php echo base_url("/theme/bot/bot-icon.png"); ?>"></figure>'+data.message+'</div>');
...
$(function () {
    ...
    $( ".chat-logo" ).click(function() {
        localStorage.chatopen=1
        $(".chat").show();
        $(".chat-logo").hide();
    });
    $( ".close-bot" ).click(function() {
        localStorage.chatopen=2
        $(".chat").hide();
        $(".chat-logo").show();
    });
