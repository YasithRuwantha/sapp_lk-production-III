...
<html lang="en">
    <head>
		...
		<!-- Datatables CSS -->
		<link rel="stylesheet" href="https://mis-sapp.com/public/theme/html-files/template/assets/plugins/datatables/datatables.min.css">
        <link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.2.3/css/buttons.dataTables.min.css">
		
		<!-- Main CSS -->
        <link rel="stylesheet" href="https://mis-sapp.com/public/theme/html-files/template/assets/css/style.css">
    ...
    <body>
			...
			<div class="header">
				...
				<ul class="nav nav-tabs user-menu">
					...
					<li class="nav-item dropdown has-arrow main-drop">
						<a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
							<span class="user-img">
								<img src="https://mis-sapp.com/public/theme/html-files/template/assets/img/profiles/avatar-01.jpg" alt="">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table class="datatable_export table table-stripped">
											<thead>
												<tr>
													<th>Name</th>
													<th>Position</th>
		...
		<!-- Bootstrap Core JS -->
		<script src="https://mis-sapp.com/public/theme/html-files/template/assets/js/bootstrap.bundle.min.js"></script>
		
		<!-- Feather Icon JS -->
		<script src="https://mis-sapp.com/public/theme/html-files/template/assets/js/feather.min.js"></script>
		
		<!-- Slimscroll JS -->
		<script src="https://mis-sapp.com/public/theme/html-files/template/assets/plugins/slimscroll/jquery.slimscroll.min.js"></script>
		...
		<!-- Custom JS -->
		<script src="https://mis-sapp.com/public/theme/html-files/template/assets/js/script.js"></script>
        <script>
