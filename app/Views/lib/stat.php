				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto">
								<a href="<?php echo base_url("/lib/stat/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="post" action="<?php echo base_url("/user/list_all/"); ?>" enctype="multipart/form-data">
										...
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
													...
													<td><?php 
                                                    $header = json_decode($val['header'],TRUE);
                                                    echo $header['REQUEST_URI'];
                                                    ?></td>
													<td><?php 
                                                    if(strlen($val['post'])>3)
                                                    { 
                                                        pre(json_decode($val['post'],TRUE)); 
                                                    } ?></td>
												</tr>
                                            <?php
                                                }
