				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto">
								<?php if(is_auth("141")){ ?>
								<a href="<?php echo base_url("/loan/add_edit/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/loan/list_all/"); ?>" enctype="multipart/form-data">
										...
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
													...
													<td><span class="badge badge-pill bg-<?php echo $status_color[$val['loan_status']]; ?>-light"><?php if(isset($loan_status[$val['loan_status']])){ echo $loan_status[$val['loan_status']]; } ?></span></td>
													<td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<?php if(is_auth("140")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/loan/view/" . $val['id']); ?>?mode=view">
																	<i class="far fa-solid fa-eye me-2" ></i >View
																</a>
															<?php } ?>
															<?php if(is_auth("142")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/loan/add_edit/" . $val['id']); ?>">
																	<i class="far fa-edit me-2" ></i >Edit
																</a>
															<?php } ?>
															<?php if(is_auth("140")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/loan_disbursement/list_all/" . $val['id'] . "/"); ?>">
																	<i class="far fa-file me-2" ></i >Loan Disbursement
																</a>
															<?php } ?>
															<?php if(is_auth("143")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/loan/delete/" . $val['id'] . "/"); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
