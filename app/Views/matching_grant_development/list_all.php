		...
		<div class="main-wrapper">
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Matching Grant Development List</li>
								</ul>
							</div>
							<div class="col-auto">
							<?php if(is_auth("153")){ ?>
								<a href="<?php echo base_url("/matching_grant_development/add_edit/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/matching_grant_development/list_all/"); ?>" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-3">
									<div class="form-group">
										...
										<select class="search-select form-select" name="<?php echo $field_name; ?>">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
										<label>Implementation ajency</label>
										<?php $field_name = "implementation_ajency"; ?>
										<input name="<?php echo $field_name; ?>" value="<?php if(isset($_GET[$field_name])){ echo $_GET[$field_name]; } ?>" type="text" class="form-control">	
									</div>
								</div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    <td><?php echo $val['matching_grant_dev_name']; ?></td>
                                                    ...
                                                    <td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<?php if(is_auth("152")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/matching_grant_development/view/" . $val['id']); ?>?mode=view">
																	<span class="material-symbols-rounded">preview</span>View
																</a>
																<?php }?>
																<?php if(is_auth("154")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/matching_grant_development/add_edit/" . $val['id']); ?>">
																	<span class="material-symbols-rounded">rate_review</span> Edit
																</a>
																<?php }?>
																<?php if(is_auth("152")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/matching_grant_activity/list_all/" . $val['id'] . "/"); ?>/">
																	<span class="material-symbols-rounded">map</span> Matching Grant Activity
																</a>
																<a class="dropdown-item" href="<?php echo base_url("/matching_grant_payment/list_all/" . $val['id'] . "/"); ?>/">
																	<span class="material-symbols-rounded">payments</span> Matching Grant Payment
																</a>
																<a class="dropdown-item" href="<?php echo base_url("/geographic_locations/list_all/matching_grant_development/" . $val['id'] . "/"); ?>/">
																	<span class="material-symbols-rounded">location_on</span> GEO Locations
																</a>
																<?php }?>
																<?php if(is_auth("155")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/matching_grant_development/delete/" . $val['id']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
