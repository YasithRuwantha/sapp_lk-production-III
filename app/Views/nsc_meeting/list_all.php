				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">NSC List</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a>
									</li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/nsc_meeting/list_all/"); ?>">NSC Meeting</a>
									</li>
									<li class="breadcrumb-item active">NSC List</li>
								</ul>
							</div>
							<div class="col-auto">
								<?php if(is_auth("75")){ ?>
								<a href="<?php echo base_url("/nsc_meeting/add_edit/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/nsc_meeting/list_all/"); ?>" enctype="multipart/form-data">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    <td><?php echo $val['nsc_meeting_no']; ?></td>
                                                    <td><?php echo $val['nsc_meeting_date']; ?></td>
                                                    <td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<?php if(is_auth("76")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/nsc_meeting/add_edit/" . $val['id']); ?>">
																<i class="far fa-edit me-1"></i>Edit
																</a>
																<?php }?>
																<?php if(is_auth("74")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/nsc_paper/list_all/" . $val['id'] . "/"); ?>">
																<i class="far fa-file me-1"></i> Nsc Paper
																</a>
																<a class="dropdown-item" href="<?php echo base_url("/nsc_sub_commitee/list_all/" . $val['id'] . "/"); ?>">
																<i class="far fa-file me-1"></i> Sub Commitee
																</a>
																<?php }?>
																<?php if(is_auth("77")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/nsc_meeting/delete/" . $val['id']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
