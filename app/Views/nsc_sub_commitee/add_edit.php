            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Sub Committee Details</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a>
									</li>
									<li class="breadcrumb-item"><a href="<?php echo base_url("/nsc_meeting/list_all/"); ?>">NSC Meeting</a></li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/nsc_sub_commitee/list_all/" . $entity_id); ?>">NSC Sub Commitee</a></li>
									<li class="breadcrumb-item active">NSC Sub Commitee Details</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">NSC Paper Details</h5>
								</div>
								<div class="card-body">
                                    <?php
                                        $inc=1;
                                    ?>
									<form method="post" action="<?php echo base_url("/nsc_sub_commitee/add_edit/" . $entity_id . "/" . $id); ?>" enctype="multipart/form-data">
