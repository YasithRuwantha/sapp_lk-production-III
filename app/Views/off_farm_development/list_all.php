				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Off Farm Development</h3>
								<ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/off_farm_development/list_all/"); ?>">Off Farm Development</a>
									</li>
									<li class="breadcrumb-item active">Off Farm Development List</li>
								</ul>
							</div>
							<div class="col-auto">
								<?php if(is_auth("123")){ ?>
								<a href="<?php echo base_url("/off_farm_development/add_edit/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/off_farm_development/list_all/"); ?>" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-3">
                                    <div class="form-group">
										<label>Off Farm Dev Name</label>
										<?php $field_name = "off_farm_dev_name"; ?>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    <td><?php echo $val['off_farm_dev_name']; ?></td>
													...
													<td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<?php if(is_auth("122")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/off_farm_development/view/" . $val['id']); ?>?mode=view">
																<i class="far fa-solid fa-eye me-2"></i>View
																</a>
																<?php } ?>
																<?php if(is_auth("124")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/off_farm_development/add_edit/" . $val['id']); ?>">
																	<i class="far fa-edit me-2" ></i >Edit
																</a>
																<?php }?>
																<?php if(is_auth("122")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/off_farm_activity/list_all/" . $val['id'] . "/"); ?>">
																	<i class="far fa-file me-2" ></i >Off Farm Activity
																</a>
																<a class="dropdown-item" href="<?php echo base_url("/off_farm_payment/list_all/" . $val['id'] . "/"); ?>">
																	<i class="far fa-file me-2" ></i >Off Farm Payment
																</a>
																<a class="dropdown-item" href="<?php echo base_url("/geographic_locations/list_all/off_farm_development/" . $val['id'] . "/"); ?>">
																	<i class="far fa-file me-2" ></i >GEO Locations
																</a>
																<?php }?>
																<?php if(is_auth("125")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/off_farm_development/delete/" . $val['id'] . "/"); ?>">
