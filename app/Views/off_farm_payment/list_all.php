		...
		<div class="main-wrapper">
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Off Farm Payment</li>
								</ul>
							</div>
							<div class="col-auto">
							<?php if(is_auth("123")){ ?>
								<a href="<?php echo base_url("/off_farm_payment/add_edit/" . $entity_id); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/off_farm_payment/list_all/" . $entity_id); ?>" enctype="multipart/form-data">
										...
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    ...
                                                    <td class="text-right">
													<?php if(is_auth("122")){ ?>
														<a class="btn btn-sm btn-white text-success me-2" href="<?php echo base_url("/off_farm_payment/view/" . $entity_id . "/" . $val['id']); ?>?mode=view">
														<i class="far fa-solid fa-eye me-2"></i>View
														</a>
													<?php } ?>
													<?php if(is_auth("124")){ ?>
														<a href="<?php echo base_url("/off_farm_payment/add_edit/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 														
													<?php } ?>
													<?php if(is_auth("125")){ ?>
														<a href="<?php echo base_url("/off_farm_payment/delete/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
													<?php } ?>
													</td>
												</tr>
                                            <?php
