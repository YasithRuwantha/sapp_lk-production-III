						...
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/procurement_bid/list_all/" . $entity_id); ?>">Procurement Bid</a></li>
									<li class="breadcrumb-item active">Procurement Bid Details</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Procurement Bid Details</h5>
								</div>
								<div class="card-body">
                                    <?php
                                        $inc=1;
                                    ?>
									<form method="post" action="<?php echo base_url("/procurement_bid/add_edit/" . $entity_id . "/" . $id); ?>" enctype="multipart/form-data">
										...
										<div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Supplier</label>
											<div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Cost</label>
											<div class="col-sm-10">
                                                <?php $field_name = "cost"; ?>
