            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Progress Assistance</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url("/progress/list_all/"); ?>">Progress</a></li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/progress_assistance/list_all/" . $entity_id); ?>">Progress Assistance</a></li>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Progress Assistance Details</h5>
								</div>
								<div class="card-body">
                                    <?php
                                        $inc=1;
                                    ?>
									<form method="post" action="<?php echo base_url("/progress_assistance/add_edit/" . $entity_id . "/" . $id); ?>" enctype="multipart/form-data">
                                        <input name="csrf" value="<?php echo $csrf; ?>" type="hidden">

										<div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Assistance input</label>
											<div class="col-sm-10">
                                                <?php $field_name = "assistance_input"; ?>
                                        ...
                                        <div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Physical progress reporting month</label>
											<div class="col-sm-10">
                                                <?php $field_name = "physical_progress_reporting_month"; ?>
										...
										<div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Physical progress reporting cumilative</label>
											<div class="col-sm-10">
                                                <?php $field_name = "physical_progress_reporting_cumilative"; ?>
										...
										<div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Financial progress reporting month</label>
											<div class="col-sm-10">
                                                <?php $field_name = "financial_progress_reporting_month"; ?>
                                        ...
                                        <div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Financial progress reporting cumilative</label>
											<div class="col-sm-10">
                                                <?php $field_name = "financial_progress_reporting_cumilative"; ?>
												<input type="number" step="0.01" placeholder="" class="form-control<?php if($validation->hasError($field_name)){ ?> is-invalid<?php } ?>" id="field-label-<?php echo $inc++; ?>" name="<?php echo $field_name; ?>" value="<?php if(isset($record[$field_name])){ echo $record[$field_name]; } ?>">
                                                <?php if($validation->hasError($field_name)){ ?>
                                                <div class="invalid-feedback"><?php echo $validation->getError($field_name); ?></div>
                                                <?php } ?>
                                        ...
                                        <div class="row form-group">
											<label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Assistance type</label>
											<div class="col-sm-10">
                                                <?php $field_name = "assistance_type"; ?>
												<select class="search-select form-select<?php if($validation->hasError($field_name)){ ?> is-invalid<?php } ?> entity-type" id="field-label-<?php echo $inc++; ?>" name="<?php echo $field_name; ?>">
													...
													<?php } ?>
                                                    <?php foreach($assistance_type as $key=>$val){ ?>
