								...
								<div class="card-body">
									...
									<form method="post" action="<?php echo base_url("/progress_farmer_contribution/add_edit/" . $entity_id . "/" . $id); ?>" enctype="multipart/form-data">
										...
										<div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">Other activity</label>
											<div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <label for="field-label-<?php echo $inc; ?>" class="col-form-label col-md-2">No of activity reporting month</label>
											<div class="col-sm-10">
