				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto">
							<?php if(is_auth("33")){ ?>
								<a href="<?php echo base_url("/progress_indirect_benifit/add_edit/" . $entity_id); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/progress_indirect_benifit/list_all/" . $entity_id); ?>" enctype="multipart/form-data">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    <td><?php echo $val['benifit']; ?></td>
                                                    <td><?php echo $val['reporting_month']; ?></td>     
                                                    <td><?php echo $val['cumilative']; ?></td>                                                   
                                                    <td class="text-right">
													<?php if(is_auth("34")){ ?>
														<a href="<?php echo base_url("/progress_indirect_benifit/add_edit/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 														
													<?php }?>
													<?php if(is_auth("35")){ ?>
                                                        <a href="<?php echo base_url("/progress_indirect_benifit/delete/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
													<?php }?>
													</td>
												</tr>
                                            <?php
