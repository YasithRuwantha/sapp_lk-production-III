		...
		<div class="main-wrapper">
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Project GND</li>
								</ul>
							</div>
							<div class="col-auto">
							<?php if(is_auth("15")){ ?>
								<a href="<?php echo base_url("/project_gnd/add_edit/" . $entity_id); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="post" action="<?php echo base_url("/project_gnd/list_all/" . $entity_id); ?>" enctype="multipart/form-data">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    <td><?php echo $val['gnd']; ?></td>
                                                    <td><?php echo $val['project_name']; ?></td>
                                                    <td class="text-right">
													<?php if(is_auth("16")){ ?>
														<a href="<?php echo base_url("/project_gnd/add_edit/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 														
													<?php } ?>
													<?php if(is_auth("17")){ ?>
														<a href="<?php echo base_url("/project_gnd/delete/" . $entity_id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
													<?php } ?>
													</td>
												</tr>
                                            <?php
