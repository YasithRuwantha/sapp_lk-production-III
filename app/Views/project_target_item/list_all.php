				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Project Target Item</h3>
								<ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/project_target/list_all/" . $project_id['project_id'] . "/"); ?>">Project Target</a>
									</li>
									<li class="breadcrumb-item active">Project Target Item</li>
								</ul>
							</div>
							<div class="col-auto">
							<?php if(is_auth("15")){ ?>
								<a href="<?php echo base_url("/project_target_item/add_edit/" . $entity_id); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/project_target_item/list_all/" . $entity_id); ?>" enctype="multipart/form-data">
							...
							<div class="row">
                                <div class="col-sm-6 col-md-3">
									<div class="form-group">
										...
										<?php $field_name = "item_description"; ?>
												...
												<tr>
													...
													<td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<?php if(is_auth("16")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/project_target_item/add_edit/" . $entity_id . "/" . $val['id']); ?>">
																	<i class="far fa-edit me-2" ></i >Edit
																</a>
															<?php } ?>
															<?php if(is_auth("17")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/project_target_item/delete/" . $entity_id . "/" . $val['id']); ?>">
