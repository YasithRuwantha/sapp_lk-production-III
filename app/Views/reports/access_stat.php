				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Access Stat</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Access Stat</li>
								</ul>
							</div>
                            <!--
							<div class="col-auto">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/reports/access_stat/"); ?>">
