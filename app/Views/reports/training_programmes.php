	...
	<body>
		...
		<div class="main-wrapper">
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Training Programmes</li>
								</ul>
							</div>
							<div class="col-auto">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/reports/training_programmes/"); ?>">
		...
		<script>
            $(document).ready(function(){
				...
				$( ".datepicker" ).datepicker({ minDate: "-10Y", maxDate: "+10Y", changeMonth: true, changeYear: true });
