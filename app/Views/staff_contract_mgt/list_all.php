		...
		<div class="main-wrapper">
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/staff_contract_mgt/list_all/"); ?>">Staff Contract Management</a>
									</li>
									<li class="breadcrumb-item active">Staff Contract Management List</li>
								</ul>
							</div>
							<div class="col-auto">
								<a href="<?php echo base_url("/staff_contract_mgt/add_edit/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/staff_contract_mgt/list_all/"); ?>" enctype="multipart/form-data">
                    <?php
                        $inc=1;
                    ?>
						...
						<div class="card-body pb-0">
							<div class="row">
                                <div class="col-sm-6 col-md-3">
                                    ...
                                    <label for="field-label-<?php echo $inc; ?>"><?php echo ucfirst(str_replace("_"," ","user")); ?></label>
                                    <div class="col-sm-10">                                                
										...
										<table class="table table-center table-hover datatable">
											<thead class="thead-light">
												<tr>
													...
													<th><?php echo ucfirst(str_replace("_"," ","contract_effective_date")); ?></th>
                                                    <th><?php echo ucfirst(str_replace("_"," ","contract_effective_date")); ?></th>
                                                    <th><?php echo ucfirst(str_replace("_"," ","contract_status")); ?></th>
                                            ...
                                            ?>
												<tr>
                                                    ...
                                                    <td><?php echo $val['contract_effective_date']; ?></td>
                                                    <td><?php echo $val['contract_expiary_date']; ?></td>
                                                    <td><?php echo $contract_status[$val['contract_status']]; ?></td>
                                                    <td class="text-right">
														<a href="<?php echo base_url("/staff_contract_mgt/add_edit/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 														
                                                        <a href="<?php echo base_url("/staff_contract_mgt/delete/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
													</td>
												</tr>
                                            <?php
                                                }
