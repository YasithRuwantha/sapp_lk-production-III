				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto">
							<?php if(is_auth("39")){ ?>
								<a href="<?php echo base_url("/staff_leave/add_edit/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/staff_leave/list_all/"); ?>">
												...
												<tr>
                                                    ...
                                                    <td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<?php if(is_auth("38")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/staff_leave/add_edit/" . $val['id']); ?>?mode=view">
