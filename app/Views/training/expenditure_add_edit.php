				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto">
							<?php if(is_auth("27")){ ?>
								<a href="<?php echo base_url("/training/expenditure_add_edit/" . $id . "/"); ?>" class="btn btn-primary me-1">
							...
							<div class="card">
								...
								<div class="card-body">
                                    <?php
                                        $inc=1;
                                    ?>
									<form method="post" action="<?php echo base_url("/training/expenditure_add_edit/" . $id . "/" . $resid); ?>" enctype="multipart/form-data">
                                        <input name="csrf" value="<?php echo $csrf; ?>" type="hidden">
                                        
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row form-group">
                                                    <label for="field-label-<?php echo $inc; ?>" class="col-form-label">Expenditure type</label>
                                                    <div class="">
                                                        <?php $field_name = "expenditure_type"; ?>
                                                        <select class="form-select<?php if($validation->hasError($field_name)){ ?> is-invalid<?php } ?>" id="field-label-<?php echo $inc++; ?>" name="<?php echo $field_name; ?>">
                                                            ...
                                                            <?php } ?>
                                                            <?php foreach($expenditure_type as $key=>$val){ ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row form-group">
                                                    <label for="field-label-<?php echo $inc; ?>" class="col-form-label">Amount</label>
                                                    <div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
                                            ...
                                            ?>
												<tr>
                                                    <td><?php echo $expenditure_type[$val['expenditure_type']]; ?></td>
													<td><?php echo $val['amount']; ?></td>
                                                    <td><?php echo $val['training_name']; ?></td>
                                                    <td class="text-right">
													<?php if(is_auth("28")){ ?>
                                                        <a href="<?php echo base_url("/training/expenditure_add_edit/" . $id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a> 
													<?php } ?>
													<?php if(is_auth("29")){ ?>
														<a href="<?php echo base_url("/training/expenditure_delete/" . $id . "/" . $val['id']); ?>" class="btn btn-sm btn-white text-danger me-2" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt me-1"></i>Delete</a>
													<?php } ?>
													</td>
												</tr>
                                            <?php
