		...
		<div class="main-wrapper">
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("/user_group/list_all/"); ?>">User Group</a>
									</li>
									<li class="breadcrumb-item active">User Group List</li>
								</ul>
							</div>
							<div class="col-auto">
							<?php if(is_auth("165")){ ?>
								<a href="<?php echo base_url("/user_group/add_edit/"); ?>" class="btn btn-primary me-1">
					...
					<!-- Search Filter -->
                    <form method="get" action="<?php echo base_url("/user_group/list_all/"); ?>" enctype="multipart/form-data">
                    <?php
                        $inc=1;
                    ?>
									...
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
											<thead class="thead-light">
												<tr>
													<th><?php echo ucfirst(str_replace("_"," ","group_name")); ?></th>
												...
												<tr>
                                                    ...
                                                    <td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<?php if(is_auth("164")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/user_group/add_edit/" . $val['id']); ?>?mode=view">
																	<i class="far fa-eye me-2" ></i >View
																</a>
																<?php }?>
																<?php if(is_auth("166")){ ?>
																<a class="dropdown-item" href="<?php echo base_url("/user_group/add_edit/" . $val['id']); ?>">
																	<i class="far fa-edit me-2" ></i >Edit
																</a>
																<?php } ?>	
																<?php if(is_auth("167")){ ?>															
																<a class="dropdown-item" href="<?php echo base_url("/user_group/delete/" . $val['id']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
