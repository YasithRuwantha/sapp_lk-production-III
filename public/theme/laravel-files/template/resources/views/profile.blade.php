										...
										<div class="card-body card-body-height">
											<ul class="activity-feed">
												<li class="feed-item">
													...
													<span class="feed-text"><a href="profile">Brian Johnson</a> has paid the invoice <a href="view-invoice">"#DF65485"</a></span>
												</li>
												<li class="feed-item">
													<div class="feed-date">Nov 7</div>
													<span class="feed-text"><a href="profile">Marie Canales</a>  has accepted your estimate <a href="view-estimate">#GTR458789</a></span>
												</li>
												<li class="feed-item">
													<div class="feed-date">Oct 24</div>
													<span class="feed-text">New expenses added <a href="expenses">"#TR018756</a></span>
												</li>
												<li class="feed-item">
													<div class="feed-date">Oct 24</div>
													<span class="feed-text">New expenses added <a href="expenses">"#TR018756</a></span>
												...
												<li class="feed-item">
													...
													<span class="feed-text"><a href="profile">Robert Martin</a> gave a review for <a href="product-details">"Dell Laptop"</a></span>
												</li>
												<li class="feed-item">
													<div class="feed-date">Jan 14</div>
													<span class="feed-text">New customer registered <a href="profile">"Tori Carter"</a></span>
												</li>
											</ul>
										</div>
									</div>
