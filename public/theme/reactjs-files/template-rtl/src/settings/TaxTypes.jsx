                                    ...
                                    <div className="card-header">
                                        <div className="row">
                                            ...
                                            <div className="col-auto">
                                                <a href="#" className="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#add_tax">Add New Tax</a>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="text-right">
                                                            <a href="#" data-toggle="modal" data-target="#edit_tax" className="btn btn-sm btn-white text-success me-2"><i className="far fa-edit me-1"></i> Edit</a> 
                                                            <a href="#" data-toggle="modal" data-target="#delete_tax" className="btn btn-sm btn-white text-danger me-2"><i className="far fa-trash-alt me-1"></i>Delete</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>GST</td>
