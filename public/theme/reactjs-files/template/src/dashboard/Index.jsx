						...
						<div className="col-xl-3 col-sm-6 col-12">
							<div className="card">
								<div className="card-body">
									...
									<p className="text-muted mt-3 mb-0"><span className="text-danger mr-1"><i className="fas fa-arrow-down mr-1"></i>1.15%</span> since last week</p>
								</div>
							</div>
						</div>
						<div className="col-xl-3 col-sm-6 col-12">
							<div className="card">
								<div className="card-body">
									...
									<p className="text-muted mt-3 mb-0"><span className="text-success mr-1"><i className="fas fa-arrow-up mr-1"></i>2.37%</span> since last week</p>
								</div>
							</div>
						</div>
						<div className="col-xl-3 col-sm-6 col-12">
							<div className="card">
								<div className="card-body">
									...
									<p className="text-muted mt-3 mb-0"><span className="text-success mr-1"><i className="fas fa-arrow-up mr-1"></i>3.77%</span> since last week</p>
								</div>
							</div>
						</div>
						<div className="col-xl-3 col-sm-6 col-12">
							<div className="card">
								<div className="card-body">
									...
									<p className="text-muted mt-3 mb-0"><span className="text-danger mr-1"><i className="fas fa-arrow-down mr-1"></i>8.68%</span> since last week</p>
								</div>
							</div>
						</div>
					</div>
								...
								<div className="card-body">
									...
									<div className="text-center text-muted">
										<div className="row">
											<div className="col-4">
												<div className="mt-4">
													<p className="mb-2 text-truncate"><i className="fas fa-circle text-primary mr-1"></i> Invoiced</p>
													<h5>$ 2,132</h5>
												</div>
											</div>
											<div className="col-4">
												<div className="mt-4">
													<p className="mb-2 text-truncate"><i className="fas fa-circle text-success mr-1"></i> Received</p>
													<h5>$ 1,763</h5>
												</div>
											</div>
											<div className="col-4">
												<div className="mt-4">
													<p className="mb-2 text-truncate"><i className="fas fa-circle text-danger mr-1"></i> Pending</p>
													<h5>$ 973</h5>
												</div>
											</div>
										</div>
												...
												<tr key={index}>
													<td>
														<h2 className="table-avatar">
															<Link to="/profile"><img className="aavatar avatar-sm mr-2 avatar-img rounded-circle" src={item.image} alt="User Image" />{item.customer_name}</Link>
														</h2>
													</td>
													<td>{item.amount}</td>
													<td>{item.due_date}</td>
													...
													<td className="text-right">
														<div className="dropdown dropdown-action">
															...
															<div className="dropdown-menu dropdown-menu-right">
																<Link className="dropdown-item" to="/edit-invoice"><i className="far fa-edit mr-2"></i>Edit</Link>
																<Link className="dropdown-item" to="/view-invoice"><i className="far fa-eye mr-2"></i>View</Link>
																<a className="dropdown-item" href=""><i className="far fa-trash-alt mr-2"></i>Delete</a>
																<a className="dropdown-item" href=""><i className="far fa-check-circle mr-2"></i>Mark as sent</a>
																<a className="dropdown-item" href=""><i className="far fa-paper-plane mr-2"></i>Send Invoice</a>
																<a className="dropdown-item" href=""><i className="far fa-copy mr-2"></i>Clone Invoice</a>
															</div>
														</div>
													</td>
												</tr>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="mb-3">
										...
										<div className="row">
											<div className="col-auto">
												<i className="fas fa-circle text-success mr-1"></i> Sent
											</div>
											<div className="col-auto">
												<i className="fas fa-circle text-warning mr-1"></i> Draft
											</div>
											<div className="col-auto">
												<i className="fas fa-circle text-danger mr-1"></i> Expired
											</div>
										</div>
									</div>
									<div className="table-responsive">
										<table className="table table-hover">
											...
											{recentestimates_.map((item, index) => {
												...
												<tr key={index}>
													<td>
														<h2 className="table-avatar">
															<a href="/profile"><img className="aavatar avatar-sm mr-2 avatar-img rounded-circle" src={item.image} alt="User Image" />{item.customer_name}</a>
														</h2>
													</td>
													...
													<td className="text-right">
														<div className="dropdown dropdown-action">
															...
															<div className="dropdown-menu dropdown-menu-right">
																<Link className="dropdown-item" to="/edit-invoice"><i className="far fa-edit mr-2"></i>Edit</Link>
																<a className="dropdown-item" href="#"><i className="far fa-trash-alt mr-2"></i>Delete</a>
																<Link className="dropdown-item" to="/view-estimate"><i className="far fa-eye mr-2"></i>View</Link>
																<a className="dropdown-item" href="#"><i className="far fa-file-alt mr-2"></i>Convert to Invoice</a>
																<a className="dropdown-item" href="#"><i className="far fa-check-circle mr-2"></i>Mark as sent</a>
																<a className="dropdown-item" href="#"><i className="far fa-paper-plane mr-2"></i>Send Estimate</a>
																<a className="dropdown-item" href="#"><i className="far fa-check-circle mr-2"></i>Mark as Accepted</a>
																<a className="dropdown-item" href="#"><i className="far fa-times-circle mr-2"></i>Mark as Rejected</a>
															</div>
														</div>
													</td>
												</tr>
