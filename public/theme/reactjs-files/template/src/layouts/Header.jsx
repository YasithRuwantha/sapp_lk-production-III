				...
				<ul className="nav user-menu">
					...
					<li className="nav-item dropdown has-arrow main-drop">
						...
						<div className="dropdown-menu">
							...
							<Link className="dropdown-item" to="/settings"><FeatherIcon icon="settings" className="mr-1" />Settings</Link>
							<Link className="dropdown-item" to="/login"><FeatherIcon icon="log-out" className="mr-1" />Logout</Link>
						</div>
					</li>
